...
stdenv.mkDerivation (attrs // {
  ...
  installPhase = attrs.installPhase or ''
    ...
    ruby ${./nix-gem-install.rb} "$spec"
    ''}

    runHook postInstall
  '';

  propagatedBuildInputs = [ rubygems ] ++ gemPath ++ propagatedBuildInputs;
  propagatedUserEnvPkgs = [ rubygems ] ++ gemPath ++ propagatedUserEnvPkgs;
